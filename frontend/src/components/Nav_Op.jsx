      ...
      <header className="fixed top-0 w-full z-50 bg-gradient-to-r from-primary-400 via-primary-500 to-primary-600 py-2 sm:py-3 md:py-3 lg:py-4 shadow-lg">
        <div className="flex justify-between items-center mx-2 sm:mx-3 md:mx-4 lg:mx-5">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link to="/operator">
              <h1 className="ml-4 text-primary-800 text-sm sm:text-xl md:text-2xl lg:text-3xl font-bold rounded-xl px-2 transition-transform duration-300 hover:scale-110 hover:shadow-lg">
                Ramjee Singh And Co.
              </h1>
            </Link>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-3 md:gap-4 lg:gap-6">
            ...
            <button
              ...
              className="p-2 text-primary-800 hover:text-primary-900 transition-colors"
            >
              {isFullscreen ? (
            ...
            {/* User Icon and Name */}
            <div className="flex items-center gap-2">
              <FaUser className="text-lg sm:text-xl text-primary-800" />
              <span className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold text-primary-800">
                {username}
              </span>
              <div className="flex items-center gap-2">
                <FaRoute className="text-lg sm:text-xl text-primary-900" />
                <span className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold text-primary-900">
                  {route || 'N/A'}
                </span>
              </div>
            </div>
